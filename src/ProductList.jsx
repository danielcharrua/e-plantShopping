...
function ProductList({ onHomeClick }) {
    ...
    const handlePlantsClick = (e) => {
        e.preventDefault();
        setShowPlants(true); // Set setShowPlants to true when Plants is clicked
    ...
    const handleAddToCart = (product) => {
        ...
        dispatch(addItem(product)); // Dispatch the action to add the plant to the cart (Redux action)

        setAddedToCart((prevState) => ({
            ...prevState,
            [product.name]: true // Track added items by name
        }));
    };
                    ...
                    <div>
                        <a href="#" onClick={(e) => handleCartClick(e)} style={styleA}>
                            <h1 className='cart'>
                                ...
                                <span className="cart-count">{useSelector((state) => state.cart.items.length)}</span>
                            </h1>
                        </a>
                    </div>
                </div>
